...
$(document).ready(function(){
	...
	$(".card-header-right .reload-card").on("click",function(){
		var a=$(this);a.parents(".card").addClass("card-load");
	...
	$("#styleSelector .style-cont").mCustomScrollbar(
		{
			setTop:"10px",setHeight:"calc(100% - 200px)",
		});
