    ...
    <div class="col-lg-12">
      <div class="card">
        <div class="card-block">
      	   ...
      	   <h3> <i class="fa fa-map-marker"></i> &nbsp; Editar Árbol </h3> <br>
                ...
                <div class="row">
                        ...
                        <div class="input-group" id="place_n">                    
                          ...
                          <input type="text" class="form-control col-lg-6"
                          	...
                          	<span class="input-group-addon"> 
                          		<button type="button" id="place" class="btn btn-danger btn-xs"> <i class="fa fa-magic"></i> </button>
                          	</span>                    
                        </div>
                      ...
                      <div class="form-group">
                        <label for="healt"> Estado de Vitalidad: </label>
                          ...
                          <div class="input-group" id="vitality">                    
	                          	...
	                          	<span class="input-group-addon"> 
	                          		<button type="button" id="vitality" class="btn btn-danger btn-xs"> <i class="fa fa-magic"></i> </button>
	                          	</span>                    
                        	</div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group" id="nest_n">                    
                      	...
                      	<span class="input-group-addon"> 
                      		<button type="button" id="nest" class="btn btn-danger btn-xs"> <i class="fa fa-magic"></i> </button>
                      	</span>                    
                	</div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group" id="bats_n">                    
                      	...
                      	<span class="input-group-addon"> 
                      		<button type="button" id="bats" class="btn btn-danger btn-xs"> <i class="fa fa-magic"></i> </button>
                      	</span>                    
                	</div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group" id="iguana_n">                    
                      	...
                      	<span class="input-group-addon"> 
                      		<button type="button" id="iguana" class="btn btn-danger btn-xs"> <i class="fa fa-magic"></i> </button>
                      	</span>                    
                	</div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group" id="chipmunk_n">                    
                      	...
                      	<span class="input-group-addon"> 
                      		<button type="button" id="chipmunk" class="btn btn-danger btn-xs"> <i class="fa fa-magic"></i> </button>
                      	</span>                    
                	</div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group" id="zariguella_n">                    
                      	...
                      	<span class="input-group-addon"> 
                      		<button type="button" id="zariguella" class="btn btn-danger btn-xs"> <i class="fa fa-magic"></i> </button>
                      	</span>                    
                	</div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group" id="nest_insect_n">                    
                      	...
                      	<span class="input-group-addon"> 
                      		<button type="button" id="nest_insect" class="btn btn-danger btn-xs"> <i class="fa fa-magic"></i> </button>
                      	</span>                    
                	</div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group" id="dove_n">                    
                      	...
                      	<span class="input-group-addon"> 
                      		<button type="button" id="dove" class="btn btn-danger btn-xs"> <i class="fa fa-magic"></i> </button>
                      	</span>                    
                	</div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group" id="ants_n">                    
                      	...
                      	<span class="input-group-addon"> 
                      		<button type="button" id="ants" class="btn btn-danger btn-xs"> <i class="fa fa-magic"></i> </button>
                      	</span>                    
                	</div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group" id="root_tree_n">                    
                      	...
                      	<span class="input-group-addon"> 
                      		<button type="button" id="root_tree" class="btn btn-danger btn-xs"> <i class="fa fa-magic"></i> </button>
                      	</span>                    
                	</div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group" id="trunk_distorted_n">                    
                      	...
                      	<span class="input-group-addon"> 
                      		<button type="button" id="trunk_distorted" class="btn btn-danger btn-xs"> <i class="fa fa-magic"></i> </button>
                      	</span>                    
                	</div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group" id="branch_dry_n">                    
                  		...
                  		<input type="text" class="form-control col-lg-6"  
	                      	...
	                      	<span class="input-group-addon"> 
	                      		<button type="button" id="branch_dry" class="btn btn-danger btn-xs"> <i class="fa fa-magic"></i> </button>
	                      	</span>                    
                		</div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group" id="root_healt_n">                    
                  		...
                  		<input type="text" class="form-control col-lg-6"  
	                      	...
	                      	<span class="input-group-addon"> 
	                      		<button type="button" id="root_healt" class="btn btn-danger btn-xs"> <i class="fa fa-magic"></i> </button>
	                      	</span>                    
                		</div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group" id="trunk_healt_n">                    
                  		...
                  		<input type="text" class="form-control col-lg-6"  
	                      	...
	                      	<span class="input-group-addon"> 
	                      		<button type="button" id="trunk_healt" class="btn btn-danger btn-xs"> <i class="fa fa-magic"></i> </button>
	                      	</span>                    
                		</div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group" id="cup_healt_n">                    
                  		...
                  		<input type="text" class="form-control col-lg-6"  
	                      	...
	                      	<span class="input-group-addon"> 
	                      		<button type="button" id="cup_healt" class="btn btn-danger btn-xs"> <i class="fa fa-magic"></i> </button>
	                      	</span>                    
                		</div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group" id="root_wounds_n">                    
                  		...
                  		<input type="text" class="form-control col-lg-6"  
	                      	...
	                      	<span class="input-group-addon"> 
	                      		<button type="button" id="root_wounds" class="btn btn-danger btn-xs"> <i class="fa fa-magic"></i> </button>
	                      	</span>                    
                		</div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group" id="steam_wounds_n">                    
                  		...
                  		<input type="text" class="form-control col-lg-6"  
	                      	...
	                      	<span class="input-group-addon"> 
	                      		<button type="button" id="steam_wounds" class="btn btn-danger btn-xs"> <i class="fa fa-magic"></i> </button>
	                      	</span>                    
                		</div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group" id="branch_wounds_n">                    
                  		...
                  		<input type="text" class="form-control col-lg-6"  
	                      	...
	                      	<span class="input-group-addon"> 
	                      		<button type="button" id="branch_wounds" class="btn btn-danger btn-xs"> <i class="fa fa-magic"></i> </button>
	                      	</span>                    
                		</div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group" id="cut_tecnic_n">                    
                  		...
                  		<input type="text" class="form-control col-lg-6"  
	                      	...
	                      	<span class="input-group-addon"> 
	                      		<button type="button" id="cut_tecnic" class="btn btn-danger btn-xs"> <i class="fa fa-magic"></i> </button>
	                      	</span>                    
                		</div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group" id="trunk_wounds_n">                    
                  		...
                  		<input type="text" class="form-control col-lg-6"  
	                      	...
	                      	<span class="input-group-addon"> 
	                      		<button type="button" id="trunk_wounds" class="btn btn-danger btn-xs"> <i class="fa fa-magic"></i> </button>
	                      	</span>                    
                		</div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group" id="parasite_n">                    
                  		...
                  		<input type="text" class="form-control col-lg-6"  
	                      	...
	                      	<span class="input-group-addon"> 
	                      		<button type="button" id="parasite" class="btn btn-danger btn-xs"> <i class="fa fa-magic"></i> </button>
	                      	</span>                    
                		</div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group" id="structure_floor_n">                    
                  		...
                  		<input type="text" class="form-control col-lg-6"  
	                      	...
	                      	<span class="input-group-addon"> 
	                      		<button type="button" id="structure_floor" class="btn btn-danger btn-xs"> <i class="fa fa-magic"></i> </button>
	                      	</span>                    
                		</div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group" id="infraestructure_private_n">                    
                  		...
                  		<input type="text" class="form-control col-lg-6"  
	                      	...
	                      	<span class="input-group-addon"> 
	                      		<button type="button" id="infraestructure_private" class="btn btn-danger btn-xs"> <i class="fa fa-magic"></i> </button>
	                      	</span>                    
                		</div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group" id="infraestructure_public_n">                    
                  		...
                  		<input type="text" class="form-control col-lg-6"  
	                      	...
	                      	<span class="input-group-addon"> 
	                      		<button type="button" id="infraestructure_public" class="btn btn-danger btn-xs"> <i class="fa fa-magic"></i> </button>
	                      	</span>                    
                		</div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group" id="cable_light_n">                    
                  		...
                  		<input type="text" class="form-control col-lg-6"  
	                      	...
	                      	<span class="input-group-addon"> 
	                      		<button type="button" id="cable_light" class="btn btn-danger btn-xs"> <i class="fa fa-magic"></i> </button>
	                      	</span>                    
                		</div>
              ...
              <div class="col-lg-2">
                  <button type="submit" class="btn btn-success btn-md"> <i class="fa fa-tree"> </i> &nbsp; Actualizar </button>
              </div>
...
@section('js')
    ...
    <script>
    	$(document).ready(function (){
    		...
    		$('button#vitality').click(function (){
    			$('div#vitality').hide();
    			$('div#healt').show();
    		});
    		...
    		$('button#bats').click(function (){
    			$('div#bats_n').hide();
                $('div#bats').show();
    		});

    		$('button#iguana').click(function (){
    			$('div#iguana_n').hide();
    			$('div#iguana').show();
    		});

    		$('button#chipmunk').click(function (){
    			$('div#chipmunk_n').hide();
    			$('div#chipmunk').show();
    		});

    		$('button#zariguella').click(function (){
    			$('div#zariguella_n').hide();
    			$('div#zariguella').show();
    		});

    		$('button#nest_insect').click(function (){
    			$('div#nest_insect_n').hide();
    			$('div#nest_insect').show();
    		});

    		$('button#dove').click(function (){
    			$('div#dove_n').hide();
    			$('div#dove').show();
    		});

    		$('button#ants').click(function (){
    			$('div#ants_n').hide();
    			$('div#ants').show();
    		});

    		$('button#root_tree').click(function (){
    			$('div#root_tree_n').hide();
    			$('div#root_tree').show();
    		});

    		$('button#trunk_distorted').click(function (){
    			$('div#trunk_distorted_n').hide();
    			$('div#trunk_distorted').show();
    		});

    		$('button#branch_dry').click(function (){
    			$('div#branch_dry_n').hide();
    			$('div#branch_dry').show();
    		});

    		$('button#root_healt').click(function (){
    			$('div#root_healt_n').hide();
    			$('div#root_healt').show();
    		});

    		$('button#trunk_healt').click(function (){
    			$('div#trunk_healt_n').hide();
    			$('div#trunk_healt').show();
    		});

    		$('button#root_wounds').click(function (){
    			$('div#root_wounds_n').hide();
    			$('div#root_wounds').show();
    		});

    		$('button#steam_wounds').click(function (){
    			$('div#steam_wounds_n').hide();
    			$('div#steam_wounds').show();
    		});

    		$('button#cut_tecnic').click(function (){
    			$('div#cut_tecnic_n').hide();
    			$('div#cut_tecnic').show();
    		});

    		$('button#trunk_wounds').click(function (){
    			$('div#trunk_wounds_n').hide();
    			$('div#trunk_wounds').show();
    		});

			$('button#parasite').click(function (){
    			$('div#parasite_n').hide();
    			$('div#parasite').show();
    		});

    		$('button#structure_floor').click(function (){
    			$('div#structure_floor_n').hide();
    			$('div#structure_floor').show();
    		});

    		$('button#infraestructure_private').click(function (){
    			$('div#infraestructure_private_n').hide();
    			$('div#infraestructure_private').show();
    		});

    		$('button#infraestructure_public').click(function (){
    			$('div#infraestructure_public_n').hide();
    			$('div#infraestructure_public').show();
    		});

    		$('button#cable_light').click(function (){
    			$('div#cable_light_n').hide();
    			$('div#cable_light').show();
    		});

    		$('button#branch_wounds').click(function (){
    			$('div#branch_wounds_n').hide();
    			$('div#branch_wounds').show();
    		});


    		$('button#cup_healt').click(function (){
