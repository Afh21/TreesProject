...
@section('content')
  <style>
  	.red-text { color: red; font-size: 0.7em; font-weight: thin }
  	.red-text-table, .advert { color: red; font-size: 0.557em; font-weight: thin }
    ...
    <div class="col-lg-12">
      <div class="card">
        <div class="card-block">
			...
			<i class="fa fa-fire"></i> &nbsp; &nbsp; <b> Crear Huella Carbono </b>
				...
				<div class="col-lg-12" style="padding: 15px 15px"></div>				
					...
					<div class="jumbotron text-center" style="height: 10px !important ; background-color: yellow"> <bold> Por favor, diligencie con total claridad y sinceridad posible. Gracias. </bold> </div>
								    ...
								    <label for="rol"> <i class="fa fa-cog"></i> Rol</label>
								   	<ul style="list-style-type: none" >							    		
							    		...
							    		<li style="display: inline-flex; padding:7px">
							    			<label for="admin"> 
							    				<i class="fa fa-diamond" style="margin: 0px"> </i> Profesor / Administrador </label>
							    				&nbsp; &nbsp;<input type="radio" name="type" checked="checked" value="1" id="admin">	
							    		</li>							    	
							    		@else
							    		<li style="display: inline-flex; padding:7px">
							    			<label for="student"> 
							    				<i class="fa fa-suitcase" style="margin: 0px"> </i> Geolocalizador </label>
									...
									<table class="table stylish-table">																		
										...
										<tbody>
											...
											<tr>
												...
												<td>¿Horas al día? <small class="advert"> Debe ser <= 24 &nbsp; <i class="fa fa-hand-o-right fa-2x"></i></small> </small> </td>
												<td>
													<input 
														type="text" 
														id="bus" name="bus" 
											...
											<tr>
												<td>Transmilenio</td>
												<td>¿Horas al día? <br> <small class="advert"> Debe ser <= 24 &nbsp; <i class="fa fa-hand-o-right fa-2x"></i></small> </small> </td>
												<td>
													<input 
														type="text" 
											...
											<tr>
												<td>Avión</td>
												<td>¿Horas al día? <small class="advert"> Debe ser <= 24 &nbsp; <i class="fa fa-hand-o-right fa-2x"></i></small> </td>
												<td>
													<input 
														type="text" 
														id="avion" name="avion" 
		...
		$(document).ready(function () {		
			...
			$('button[type=button]').click((e)=>{				
				...
				for (var i = 0 ; i < parseInt(kg.length) ; i ++) {					
					...
					//console.log("Array: " + parseInt( kg[i] ) )
